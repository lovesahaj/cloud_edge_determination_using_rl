...
public class MultiRLChart extends Chart {
	...
	public void update() {
		...
		if (simulationManager.getScenario().getStringOrchAlgorithm().equals("PYTHON_NEURAL_NET")) {
			totalTasksList.add((double) ((DefaultOrchestrator) simulationManager.getOrchestrator()).getMultiLayerRLManagerPython().getTotalTasks());
			AsksTasksList.add((double) ((DefaultOrchestrator) simulationManager.getOrchestrator()).getMultiLayerRLManagerPython().getAskTasks());
		} else {
			totalTasksList.add((double) ((DefaultOrchestrator) simulationManager.getOrchestrator()).getMultiLayerRLManager().getTotalTasks());
			AsksTasksList.add((double) ((DefaultOrchestrator) simulationManager.getOrchestrator()).getMultiLayerRLManager().getAskTasks());
		}
