...
public abstract class SimulationAbstract {
	 ...
	 */
	protected  String simConfigfile = "simulation_parameters.properties";
	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String applicationsFile = "applications.xml";
	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String edgeDataCentersFile = "edge_datacenters.xml";
	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String edgeDevicesFile = "edge_devices.xml";
	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String cloudFile = "cloud.xml";
	
	/**
	 * @see #setCustomOutputFolder(String)
	 */
	protected static  String outputFolder = "src/main/java/output/";
	...
	public void setCustomOutputFolder(String outputFolder) {
		SimulationAbstract.outputFolder = outputFolder;
	}
